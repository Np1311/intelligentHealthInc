...
urlpatterns = [
    ...
    # path('saveNotes/<str:record_id>/', views.saveNotes,name='save_notes'),
    ...
    path('updateImageFindings/<str:record_id>/', views.updateImageFindings, name='update_image_findings'),
]
